...
2. **Visualizing Residuals:** For each of the three models, create a residual plot showing the prediction errors (actual - predicted) on the y-axis versus the predicted values on the x-axis, using the train data. Which model shows the most random pattern? Which shows systematic patterns indicating poor fit?
