...
# 📊 Day 6: Advanced EDA & Patterns - In-Class Activity
...
Create a scatter plot showing `Logged_GDP_per_capita` (Log GDP per capita) on the x-axis and `happiness` (Happiness Score) on the y-axis from the `whr_data` dataset. Add a linear regression line (`geom_smooth(method = "lm", se = FALSE)`) to visualize the overall trend.
