...
**Hint:** A good plot for a linear model should show a random scatter of points around the horizontal line at $y=0$. Patterns such as a U-shape, a curve, or a fan-like spread would suggest that the linearity assumption has been violated.
