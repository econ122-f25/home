...
- We download a dataset on age, income, education 
- First Qs: What is the distribution of each variable? Is there a relationship between age, income, and edcation?
...
* Useful `ggplot` cheat sheet in `RStudio`
